...
export class HomepageComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(PLATFORM_ID) private platformId: any,
      ...
      this.titleService.setTitle('Infraon Helpdesk')
      this._metaTagService.updateTag({ name: 'title', content: 'Infraon Helpdesk' });
      this._metaTagService.updateTag({ name: 'description', content: 'Infraon Helpdesk' });
      this._canonical.updateCanonicalUrl('https://infraon.io/infraon-helpdesk');      
    }
