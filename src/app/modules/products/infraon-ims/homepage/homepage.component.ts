...
export class HomepageComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(PLATFORM_ID) private platformId: any,
      ...
      this.titleService.setTitle('IT Infrastructure Management Services(IMS) and Solutions - Infraon')
      this._metaTagService.updateTag({ name: 'title', content: 'IT Infrastructure Management Services(IMS) and Solutions - Infraon' });
      this._metaTagService.updateTag({ name: 'description', content: 'IT infrastructure management service (IMS) - A Complete Unified Infrastructure Monitoring Suite for IT, Networking, Cloud, App, & IoT devices.' });
      this._canonical.updateCanonicalUrl('https://infraon.io/infraon-ims');
