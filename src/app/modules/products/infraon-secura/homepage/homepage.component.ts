...
export class HomepageComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(PLATFORM_ID) private platformId: any,
      ...
      this.titleService.setTitle('Secure Remote Access Software | Remote Control software | Zero Trust Security Access |  Infraon  Secura')
      this._metaTagService.updateTag({ name: 'title', content: 'Secure Remote Access Software | Remote Control software | Zero Trust Security Access |  Infraon  Secura' });
      this._metaTagService.updateTag({ name: 'description', content: 'Searching for the best secure remote access software?  Infraon  Secura is a highly secure remote access software with zero trust security features. Download a free version now!' });
      this._canonical.updateCanonicalUrl('https://infraon.io/infraon-secura');
