...
export class HomepageComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(PLATFORM_ID) private platformId: any,
      ...
      this.titleService.setTitle('Artificial Intelligence Software for IT Operations | Infraon AIOps')
      this._metaTagService.updateTag({ name: 'title', content: 'Artificial Intelligence Software for IT Operations | Infraon AIOps' });
      this._metaTagService.updateTag({ name: 'description', content: 'A platform-centric AI/ML-driven approach for centralizing and processing huge amounts of IT-related data from disparate sources. Empower multiple teams to be more responsive to outages and slowdowns and get bi-directional connectivity with ITSM technologies.' });
      this._canonical.updateCanonicalUrl('https://infraon.io/infraon-aiops');
