...
export class HomepageComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(PLATFORM_ID) private platformId: any,
      ...
      this.titleService.setTitle('Infraon Desk is an Help Desk and ITSM Software | ITIL-aligned service desk')
      this._metaTagService.updateTag({ name: 'title', content: 'Infraon Desk is an Help Desk and ITSM Software | ITIL-aligned service desk' });
      this._metaTagService.updateTag({ name: 'description', content: 'Infraon Desk is Cloud and On-Prem ITSM software for your service desk with powerful workflow automation tool to manage incidents, problems, change, request, assets and more. Try Infraon Desk ITSM Software' });
      this._canonical.updateCanonicalUrl('https://infraon.io/infraon-desk');
