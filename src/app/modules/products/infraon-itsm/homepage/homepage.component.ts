...
export class HomepageComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(PLATFORM_ID) private platformId: any
      ...
      this.titleService.setTitle('IT Service Management Software | Workflow, Incident, Problem Management | Infraon ITSM')
      this._metaTagService.updateTag({ name: 'title', content: 'IT Service Management Software | Workflow, Incident, Problem Management | Infraon ITSM' });
      this._metaTagService.updateTag({ name: 'description', content: 'IT Service Management Software - Infraon ITSM is a unified IT Service Management Platform that delivers integrated ITSM experiences. Automate daily workflows, repetitive tasks and respond to incidents or other problems 24X7. Get Started With Free Trial!' });
      this._canonical.updateCanonicalUrl('https://infraon.io/infraon-itsm');      
    }
